document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateQuotation() {
        ...
        try {
            ...
            // Limpa os documentos para enviar só números
            const r_doc_limpo = limparNumero(document.getElementById('r_document').value);
            const d_doc_limpo = limparNumero(document.getElementById('d_document').value);

            const msg = `CNPJ remetente: ${r_doc_limpo}
...
CNPJ/CPF Destinatário: ${d_doc_limpo}
...
(Possui NF: ${document.getElementById('has_invoice').value})`;
            ...
            showToast('Cotação gerada com sucesso!', 'success');
        } catch (error) {
